  ...
  return (
    <DecorativeWrapper title={"histoire"}>
      <article>
        ...
        <Paragraphes>
          Après des journées, nuits pendant tout le confinement au service des
          ses clients il a décidé de quitté son premier travail afin de se
          consacrer à 200% dans sa passion de toujours : l&apos;automobile.
        </Paragraphes>
        <Paragraphes>
          Cette passion dévorante lui a permis de grandir et de créer son
          Atelier de réparation automobile à{" "}
          <strong>La Beaujoire (Nantes)</strong>.
        </Paragraphes>
        <Paragraphes>
          Aujourd&apos;hui plus grand mais aussi accompagné !&nbsp;
          <strong>NeoCarNantes</strong> est à ce jour une entreprise familiale
          car sa femme Charlotte (Chacha) l&apos;a rejoint dans l&apos;aventure
          !
        </Paragraphes>
      </article>
    </DecorativeWrapper>
